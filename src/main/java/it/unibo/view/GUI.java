...
public class GUI extends JPanel implements ActionListener, KeyListener {
    ...
    // here are initialized the height and the width of the frame, where the game
    // will be played
    ...
    /**
     * this is the constructor of the GUI, where is initialized the dimensions, the
     * backgrond image and the play again button
     */
